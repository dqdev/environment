...
alias v='command vim'
alias fzf='fzf-tmux --preview "bat --style=numbers --color=always --line-range :500 {}"'
alias f='FILE=$(fzf-tmux --preview "bat --style=numbers --color=always --line-range :500 {}"); if [ "$FILE" ]; then vim $FILE; fi'
alias cat='bat'
